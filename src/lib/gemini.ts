...
- companyType: the single most specific/recognizable tier for the hiring company. Categories overlap, so prefer the most distinctive: FAANG (Meta, Apple, Amazon, Netflix, Google, Microsoft) > Quant (quantitative trading/research firms, e.g. Jane Street, Citadel / Citadel Securities, Two Sigma, Hudson River Trading, Jump Trading, DRW, Optiver, IMC, SIG, Akuna) > Big Tech (other large well-known tech: Nvidia, Salesforce, Adobe, Oracle, etc.) > Fortune 100 / Fortune 500 (large public companies by rank, typically non-tech-defining) > Unicorn ($1B+ private, e.g. well-funded AI/tech startups) > Startup (smaller/early private) > Enterprise (other large established firm) > Nonprofit / Government. Use "Other" only when genuinely unclear.
