...
COMPANIES: list[Company] = [
    ...
    c("Anduril", "anduril.com", careers_url="https://www.anduril.com/open-roles"),
    c("Google", "google.com",
    ...
    c("Ramp", "ramp.com", careers_url="https://ramp.com/careers"),
    ...
    c("Palantir", "palantir.com", careers_url="https://www.palantir.com/careers/"),
    ...
    c("Upstart", "upstart.com", careers_url="https://www.upstart.com/careers"),
    c("Vercel", "vercel.com"),
    ...
    c("Rubrik", "rubrik.com", careers_url="https://www.rubrik.com/company/careers"),
    c("Lyft", "lyft.com", careers_url="https://www.lyft.com/careers"),
    c("Instacart", "instacart.com",
      careers_url="https://www.instacart.careers/current-openings"),
    c("Twilio", "twilio.com"),
    c("Okta", "okta.com", careers_url="https://www.okta.com/company/careers/"),
    ...
    c("SoFi", "sofi.com", careers_url="https://www.sofi.com/careers/"),
    # ---- B+ -------------------------------------------------------------
    ...
    c("Box", "box.com"),
    c("Intuit", "intuit.com"),
    c("HubSpot", "hubspot.com", careers_url="https://www.hubspot.com/careers/jobs"),
    # ---- B --------------------------------------------------------------
    ...
    c("Etsy", "etsy.com"),
    c("Twitch", "twitch.tv", careers_url="https://www.twitch.tv/jobs/en/"),
